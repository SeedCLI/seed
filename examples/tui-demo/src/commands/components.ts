		...
		const root = column(
			...
			...[
				...
				row(
					...
					...[
						box(
							{ border: "rounded", padding: [0, 1, 0, 1], width: 35, height: 7 },
							column(
								{ gap: 0, height: 5 },
								...[
						...
						box(
							...
							column(
								{ gap: 0, height: 5 },
								...[text("Select:", { bold: true, height: 1 }), colorSelect, selectResult],
							),
						),
					],
				),
				...
				box(
					{ border: "single", padding: [0, 1, 0, 1], height: 7, width: 40 },
					column(
						{ gap: 0, height: 5 },
						...[text("Table:", { bold: true, height: 1 }), dataTable, tableResult],
					),
				),
